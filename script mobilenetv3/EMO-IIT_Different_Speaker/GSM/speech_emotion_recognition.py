...
DATASET_DIR = "Datasets/Converted Datasets/EMO-IIT_Separate_Speakers"
SPECTROGRAM_DIR = "Spectrograms/EMO-IIT_Separate_Speakers/Converted_Log"
TF_RECORDS_DIR = "TFRecords/EMO-IIT_Separate_Speakers_MobileNetV3Large"
TF_RECORDS_NAME = "EMO-IIT_Separate_Speakers_converted_log_MobileNetV3Large.tfrecords"
MODEL_DIR = "Models"
MODEL_NAME = "EMO-IIT_Separate_Speakers_converted_log_MobileNetV3Large.h5"
NUM_CLASSES = 8
SAMPLE_RATE = 16000
BATCH_SIZE = 32
EPOCHS = 50
...
ser_df_train, ser_df_test = create_dataframe_emoiit_separate_speakers()
ser_df_train, ser_df_dev = train_test_split(ser_df_train, test_size=0.2, stratify=ser_df_train.emotion, random_state=RANDOM_SEED)
...
history_json = json.load(open(os.path.join(MODEL_DIR, MODEL_NAME.replace(".h5", ".json")), "r"))
plot_history(history_json, MODEL_NAME)
